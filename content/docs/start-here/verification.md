...
If an SVG is not found, review [Placement](/docs/basics/placement/) and [Configuration](/docs/start-here/configuration/) and verify your `src` path is correct relative to `assets`.
