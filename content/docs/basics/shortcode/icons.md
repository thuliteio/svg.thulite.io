...
---
This guide explains how to render icons with the `inline-svg` shortcode. For all available arguments, see the [shortcode reference page](/docs/reference/shortcode/).

## Examples

### Icon name

To display a global resource icon of an icon set [configured](/docs/start-here/configuration/) in `iconSetDir`, use the icon name.
