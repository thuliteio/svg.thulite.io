...
---
This guide explains how to render SVGs with the `inline-svg` shortcode. For all available arguments, see the [shortcode reference page](/docs/reference/shortcode/).
